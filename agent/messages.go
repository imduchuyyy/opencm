...
const (
	...
	CmdSetPermissions  = "/set_permissions"
	CmdPermPrefix      = "/perm_"
	CmdPermReply       = "/perm_reply"
	CmdPermBan         = "/perm_ban"
	CmdPermPin         = "/perm_pin"
	CmdPermPoll        = "/perm_poll"
	CmdPermDelete      = "/perm_delete"
...
const (
	...
	MsgErrorUpdatePerm        = "Error updating permission."
	...
	MsgSaveReply              = "Reply to a message with " + CmdSave + " to save it as knowledge."
	...
	MsgErrorSaveKB            = "Error saving to knowledge base."
	MsgErrorUploadKBChat      = "Error uploading to knowledge base."
	...
	MsgPermToggled            = "Permission %s %s."
	MsgKnowledgeDeleted       = "Knowledge entry %d deleted (\"%s\")."
	MsgSavedToKB              = "Saved to knowledge base (ID: %d)"
	...
	MsgKnowledgeNoUploadShort = "Knowledge uploads are not available on the %s plan. Upgrade to Pro or Max."
	...
	MsgPromptModel = "Send me the OpenAI model name to use.\n\n" +
	...
	MsgSetupMenu = "Bot Setup Menu\n\n" +
		...
		CmdSetModel + " - OpenAI model (gpt-4o, gpt-4o-mini, etc.)\n" +
		CmdSetPermissions + " - Toggle bot permissions\n\n" +
		"Knowledge Base:\n" +
		CmdAddKnowledge + " - Upload a file (PDF, .md, .txt)\n" +
		CmdAddURL + " - Add knowledge from a URL\n" +
		CmdListKnowledge + " - View all knowledge entries\n\n" +
		"Tip: Reply " + CmdSave + " to any message in a group to save it as knowledge.\n\n" +
	...
	MsgHelp = "Available Commands\n\n" +
		...
		CmdSetModel + " - OpenAI model\n" +
		CmdSetPermissions + " - Toggle permissions\n\n" +
		"Knowledge Base:\n" +
		CmdAddKnowledge + " - Upload a file (PDF, .md, .txt)\n" +
		...
		"Reply " + CmdSave + " to any message to save it as knowledge\n\n" +
		"Info:\n" +
